...
@interface LCQNetworkLogger : NSObject

@property (class, atomic, assign) BOOL enabled;

/**
 @brief Enable/Disable Luciq's automatic masking for network logs
 */
@property (class, atomic, assign) BOOL autoMaskingEnabled;
                ...
                responseBodySize:(int64_t)responseBodySize
                 ...
                 responseHeaders:(NSDictionary *_Nullable)responseHeaders
                     ...
                     errorDomain:(NSString *_Nullable)errorDomain
                      ...
                      gRPCMethod:(NSString * _Nullable)gRPCMethod
              serverErrorMessage:(NSString *_Nullable)serverErrorMessage __attribute__((unavailable("Please update Luciq gRPC interceptor to the latest version.")));

/**
 @brief Returns new External Network Trace ID header to be used by other Luciq network interceptors. e.g. Luciq gRPC interceptor.
 */
...
/**
 @brief Disable Luciq's automatic capturing for network logs
 */
+ (void)disableAutomaticCapturingOfNetworkLogs;

/**
 @brief Enable/Disable Network logging Body for network requests and responses, It is recommended to be called before SDK Initialization
 
 @code
 LCQNetworkLogger.logBodyEnabled = true
 @endcode
*/
@property (class, atomic, assign) BOOL logBodyEnabled;
